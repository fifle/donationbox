...
<div>
    <label for="widget-language" class="block text-sm font-medium text-gray-700 mb-2">{{ __('Select the language for your embedded widget.') }}</label>
    <select id="widget-language" name="widget-language" class="block w-full pl-3 pr-10 py-2 text-sm border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 transition duration-150 ease-in-out" onchange="updateEmbedCode()">
